...
function MissionModeConfig({ handleFilenameChange }) {
  ...
  return (
    <Paper sx={{ width: "100%", padding: "25px", marginTop: "50px" }}>
      <Typography variant="h5">Параметры испытания</Typography>
      ...
      <Grid container spacing={3} sx={{ maxWidth: "600px" }}>
        <Grid item xs={6}>
          ...
          <TextField
            error={
              formik.errors.directory_name && formik.touched.directory_name
            }
            id="directory_name"
          ...
          />
          <ErrorMessage
            error={formik.errors.directory_name}
            touched={formik.touched.directory_name}
          />
        </Grid>
        ...
        <Grid item xs={6}>
          ...
          <ErrorMessage
            ...
            touched={formik.touched.file_name}
          />
        </Grid>
        ...
        <Grid item xs={12}>
          <FormControlLabel
            control={
              <Checkbox
                name="show_results"
                checked={formik.values.show_results}
                onChange={formik.handleChange}
              />
            }
            label="Показать результаты по завершении"
          />
        </Grid>
      </Grid>
    </Paper>
